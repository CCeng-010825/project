...
import { ReqUserModel, User, AllRoleResponseData, SetRoleData } from './type'
enum API {
  //获取全部已有用户账号信息
...
export function getUserData(page: number, limit: number, username: string) {
  return request<any, ReqUserModel>({
